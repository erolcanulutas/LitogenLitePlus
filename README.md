...
| 🎨 | **Colour bands** counted in printer layers: slice into as many stacked bodies as you like, pick a colour per band, exported as **3MF** — one part made of several bodies, so they stay registered |
| 🎚️ | Bands are tinted in the 3D preview exactly as the export assigns them |
